...
public class UserHomeImpl extends com.idega.data.IDOFactory implements UserHome {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.idega.user.data.UserHome#findByDateOfBirthAndGroupRelationInitiationTimeAndStatus(java.sql.Date, java.sql.Date,
	 *      com.idega.user.data.Group, java.sql.Timestamp, java.sql.Timestamp, java.lang.String[])
	 */
