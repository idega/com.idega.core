...
public java.util.Collection findGroupsRelationshipsUnder(com.idega.builder.data.IBDomain p0, com.idega.user.data.GroupDomainRelationType p1)throws java.rmi.RemoteException,javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
