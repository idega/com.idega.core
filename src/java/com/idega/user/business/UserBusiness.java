...
public class UserBusiness {
  ...
  public User insertUser(String firstname, String middlename, String lastname, String displayname, String description, Integer gender, idegaTimestamp date_of_birth, Integer primary_group) throws SQLException{
    User userToAdd = ((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).createLegacy();
    ...
    UserGroupRepresentative group = ((com.idega.user.data.UserGroupRepresentativeHome)com.idega.data.IDOLookup.getHomeLegacy(UserGroupRepresentative.class)).createLegacy();
    ...
    if(primary_group != null){
      Group prgr = ((com.idega.user.data.GroupHome)com.idega.data.IDOLookup.getHomeLegacy(Group.class)).findByPrimaryKeyLegacy(userToAdd.getPrimaryGroupID());
...
*/
  ...
  public static void deleteUser(int userId) throws SQLException {
    User delUser = ((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).findByPrimaryKeyLegacy(userId);
  ...
  public static Email getUserMail(int userId) {
    try {
      return getUserMail(((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).findByPrimaryKeyLegacy(userId));
    }
    catch (SQLException ex) {
      ex.printStackTrace();
      return null;
  ...
  public void updateUser(int user_id, String firstname, String middlename, String lastname, String displayname, String description, Integer gender, idegaTimestamp date_of_birth, Integer primary_group ) throws SQLException {
    User userToUpdate = ((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).findByPrimaryKeyLegacy(user_id);
  ...
  public static List getUsersInGroup(Group group) {
    try {
      return UserGroupBusiness.getUsersContained(group);  //EntityFinder.findRelated(group,com.idega.user.data.UserBMPBean.getStaticInstance());
    }
    catch (SQLException ex) {
      ex.printStackTrace();
      return null;
  ...
  public static List getUsers() throws SQLException  {
    List l = EntityFinder.findAll(com.idega.user.data.UserBMPBean.getStaticInstance());
    return l;
  }
  ...
  public static User getUser(int iUserId){
    try {
      return ((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).findByPrimaryKeyLegacy(iUserId);
    }
    catch (Exception ex) {
  ...
  public static List getUsersInNoGroup() throws SQLException  {
    ...
    List nonrelated = EntityFinder.findNonRelated(com.idega.user.data.GroupBMPBean.getStaticInstance(),com.idega.user.data.GroupBMPBean.getStaticInstance());
  ...
  public static List getUserGroupsDirectlyRelated(int iUserId){
    try {
      return getUserGroupsDirectlyRelated(((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).findByPrimaryKeyLegacy(iUserId));
    }
    catch (SQLException ex) {
      ex.printStackTrace();
      return null;
  ...
  public static List getUsersInPrimaryGroup(Group group){
    try {
  ...
  public static List getUserGroupsDirectlyRelated(User user){
    //try {
      return UserGroupBusiness.getGroupsContainingDirectlyRelated(user.getGroupID()); //  EntityFinder.findRelated(user,com.idega.user.data.GroupBMPBean.getStaticInstance());
    /*}
    catch (SQLException ex) {
      ex.printStackTrace();
      return null;
  ...
  public static List getUserGroupsNotDirectlyRelated(int iUserId){
    try {
      User user = ((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).findByPrimaryKeyLegacy(iUserId);
  ...
  public static List getAllGroupsNotDirectlyRelated(int iUserId,IWContext iwc){
    try {
      ...
      User user = ((com.idega.user.data.UserHome)com.idega.data.IDOLookup.getHomeLegacy(User.class)).findByPrimaryKeyLegacy(iUserId);
      /*List isDirectlyRelated = getUserGroupsDirectlyRelated(user);
      List AllGroups = UserGroupBusiness.getAllGroups(); //EntityFinder.findAll(com.idega.user.data.GroupBMPBean.getStaticInstance());
  ...
  public static List getUserGroups(User user, String[] groupTypes, boolean returnSepcifiedGroupTypes) throws SQLException{
    return UserGroupBusiness.getGroupsContaining(((com.idega.user.data.GroupHome)com.idega.data.IDOLookup.getHomeLegacy(Group.class)).findByPrimaryKeyLegacy(user.getGroupID()),groupTypes, returnSepcifiedGroupTypes);
  }
