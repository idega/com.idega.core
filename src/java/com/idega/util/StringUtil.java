...
public class StringUtil {
	...
	public static List getValuesFromString(String value, String separator) {
	...
	private static void addCharEntity(int aIdx, StringBuilder aBuilder) {
		addCharEntity(new Integer(aIdx), aBuilder);
	}
	...
	public static List getLinesFromString(String content) {
