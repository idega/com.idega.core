...
public class DynamicTemplateServlet extends IWJSPPresentationServlet {
	 ...
	 */
	private static final long serialVersionUID = 223240213572561359L;
	...
	public String getFirstTemplatePageClass() throws Exception {
		// Properties prop = getDefaultProperties();
		// String className =
		// prop.getProperty("idegaweb.template.default.classname");
	...
	public Page getFirstTemplatePage(IWContext iwc) throws Exception {
		...
		// Properties prop = getDefaultProperties();
		// String className =
		// prop.getProperty("idegaweb.default.templatepage.classname");
	 ...
	 * 
	 * Page page =
	 * (Page)iwc.getServletContext().getAttribute("idega_template_page");
	 * 
	 * if(page==null){
	 * 
	...
	/*
	 * 
	 * protected Properties getDefaultProperties(IWContext iwc)throws
	 * IOException{
	 * 
	 * IdegawebProperties properties =
	 * (IdegawebProperties)iwc.getServletContext().getAttribute("idegaweb_default_properties");
	 * 
	 * if (properties==null){
	 * 
	 ...
	 * 
	 * IdegawebProperties properties =
	 * (IdegawebProperties)getServletContext().getAttribute("idegaweb_default_properties");
	 * 
	 * if (properties==null){
	 * 
	 ...
	 * 
	 * 
	 * public boolean isMemberOf(IWContext iwc,String groupName)throws
	 * Exception{
	 * 
	 ...
	 * 
	 * 
	 * public boolean hasPermission(String permissionType,IWContext
	 * iwc,PresentationObject obj)throws Exception{
	 * 
