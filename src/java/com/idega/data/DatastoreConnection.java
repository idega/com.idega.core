 ...
 *  Comment in for JDK 1.4 compile compatability!!!
    ...
    public java.sql.Savepoint setSavepoint(String savepoint){return null;}

    public void rollback(java.sql.Savepoint s){}

    public void releaseSavepoint(java.sql.Savepoint s){}

    public java.sql.PreparedStatement prepareStatement(String sql, int one,int two,int three){return null;}

    public java.sql.CallableStatement prepareCall(String sql, int one,int two,int three){return null;}
