 ...
 * $Id: DatastoreInterface.java,v 1.40 2002/03/12 22:23:24 gimmi Exp $
...
//		  Stmt = conn.createStatement();
            ...
            statement.append(getAllColumnsForUpdate(entity));
...
//            debug(statement.toString(),entity);
  ...
  protected String getAllColumnsForUpdate(GenericEntity entity){
    ...
    try{
      ...
      //for (Enumeration e = columns.elements(); e.hasMoreElements();){
        ...
        else if (entity.isNull(ColumnName)){
          if (returnString==null){
            returnString = new StringBuffer("");
          }
          else{
  ...
  protected String getCreatePrimaryKeyStatementBeginning(String tableName){
    ...
    */
   public static void debug(String outputString,GenericEntity entity){
    ...
    * "debug" is set to "TRUE"
    */
   public static void debug(String outputString){
    if( IWMainApplicationSettings.isDebugActive() ){
