...
public interface ICPermissionHome extends com.idega.data.IDOHome {
 ...
 public Collection<ICPermission> findAllPermissionsByContextTypeAndPermissionGroupCollectionOrderedByContextValue(java.lang.String p0, Collection<Group> groups)throws javax.ejb.FinderException;

 public Collection<ICPermission> findAllPermissionsByContextTypeAndContextValueAndPermissionStringCollectionAndPermissionGroup(String contextType, String contextValue, Collection<String> permissionStrings, Group group) throws FinderException;
