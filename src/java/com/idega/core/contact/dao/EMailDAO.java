 ...
 */
@SpringBeanName(EMailDAO.BEAN_NAME)
public interface EMailDAO {
	public static final String BEAN_NAME = "eMailDAO";

	/**
	 *
	 * @param id is {@link Email#getId()}, not <code>null</code>;
	...
	/**
	 *
	 * @param email to update/persist, not <code>null</code>
	 ...
	 * skipped if <code>null</code>;
	 * @param description is {@link GenericType#getDescription()},
	 * skipped if <code>null</code>;
	 * @return created/updated entity or <code>null</code> on failure;
	 */
