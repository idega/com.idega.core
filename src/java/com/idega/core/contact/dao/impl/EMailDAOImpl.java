...
public class EMailDAOImpl extends GenericDaoImpl implements EMailDAO {
	...
	public void removeAllByUserId(Integer userId) {
		if (userId != null) {
			List<Email> results = getResultList(Email.QUERY_FIND_BY_USER_ID, Email.class, new com.idega.core.persistence.Param(Email.PARAM_USER_ID, userId));
			if (!ListUtil.isEmpty(results)) {
