 ...
 */
@Service(NativeQueryInlineImpl.beanIdentifier)
@Scope("prototype")
public class NativeQueryInlineImpl implements com.idega.core.persistence.Query {
	
	public static final String beanIdentifier = "NativeQueryInlineImpl";
