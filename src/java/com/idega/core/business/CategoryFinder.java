...
public class CategoryFinder {
	...
	public List listOfCategories(String type) {
		try {
			return EntityFinder.findAllByColumn(
				com.idega.core.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class),
				com.idega.core.data.ICCategoryBMPBean.getColumnType(),
				type);
		}
	...
	public List listOfValidCategories() {
		try {
			return EntityFinder.findAllByColumn(
				com.idega.core.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class),
				com.idega.core.data.ICCategoryBMPBean.getColumnValid(),
				"Y");
		}
		catch (SQLException ex) {
			return null;
		...
		try {
			...
			List L =
				EntityFinder.findRelated(
					nw,
					((com.idega.core.data.ICObjectInstanceHome) com
						.idega
						.data
						.IDOLookup
	...
	public int getObjectInstanceCategoryId(ICObjectInstance eObjectInstance) {
		try {
			List L =
				EntityFinder.findRelated(
					eObjectInstance,
					(IDOLegacyEntity) com.idega.core.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class));
			if (L != null) {
		...
		try {
			...
			List L =
				EntityFinder.getInstance().findRelated(
					obj,
					(ICCategory) com.idega.core.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class));
			return L;
		}
		catch (Exception ex) {
			return null;
		...
		/*try {
		  ...
		  return home.getRelatedSQL(iObjectInstanceId);
			...
			sql.append(" where ").append(
				((ICObjectInstance) com
					.idega
					.core
					.data
					.ICObjectInstanceBMPBean
	...
	private String getRelatedEntitySQL(String tablename, int iObjectInstanceId) {
		...
		sql.append(" = ").append(iObjectInstanceId);
		String idname =
			((ICCategory) com.idega.core.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class)).getIDColumnName();
	...
	public Map getMapOfCategoriesById(int instanceId) {
		return EntityFinder.getInstance().getMapOfEntity(
			...
			com.idega.core.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class).getIDColumnName());
	}
