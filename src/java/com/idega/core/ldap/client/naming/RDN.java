...
public class RDN
{
    ...
    public RDN(String rdn)
    {
        ...
        {
            // trim any unnecessary white spaces off both ends...
    ...
    private String specialSpaceHandling(String rdn)
    {
        ...
        if (numSlashes%2 == 0) // o.k. - we can trim that pesky space
        {
            rdn = rdn.trim();
     ...
     *    XXX - does this escape the equals sign?
     *    @param rdnfragment an attribute = value pair.
     */
    ...
    public void addRaw(String rdnfragment)
                 throws InvalidNameException
    {
        addEscaped(NameUtility.escape(rdnfragment));
    }
