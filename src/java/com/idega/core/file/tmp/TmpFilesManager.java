...
public class TmpFilesManager {
	...
	public void cleanup(String identifier, Object resource,
			TmpFileResolver resolver) {

		Collection<File> filesToClean = resolver.getFilesToCleanUp(identifier,
				resource);
	...
	public void doPeriodicalCleanup() {
		...
		if (resResolvers != null) {
			...
			for (TmpFileResolver resResolver : resResolvers) {
				...
				FileUtil.deleteAllFilesAndFolderInFolderOlderThan(resResolver
						.getRealBasePath(), EventTimer.THREAD_SLEEP_24_HOURS);
			}
		}
	}
	 ...
	 */
	public Collection<URI> getFilesUris(String identifier, Object resource,
			TmpFileResolver resolver) {
