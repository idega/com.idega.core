...
public class ICFileTypeBMPBean extends com.idega.data.CacheableEntityBMPBean implements com.idega.core.file.data.ICFileType {
	...
	public static String IC_FILE_TYPE_SYSTEM = "ic_system";// idegaWeb database
															// file system
															// (type)
	...
	public static String getColumnNameDisplayName() {
		return COLUMN_TYPE_DISPLAY_NAME;
	}

	public static String getColumnNameUniqueName() {
		return COLUMN_UNIQUE_NAME;
	}

	public static String getColumnNameDescription() {
		return COLUMN_TYPE_DESCRIPTION;
	}

	public static String getColumnNameFileTypeHandler() {
		return COLUMN_IC_FILE_TYPE_HANDLER_ID;
	}
