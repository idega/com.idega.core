...
public class ICInformationFolderBMPBean extends com.idega.data.CacheableEntityBMPBean implements com.idega.core.category.data.ICInformationFolder, com.idega.core.category.data.InformationFolder {
	 ...
	 */
	public ICInformationFolderBMPBean(int id) throws SQLException {
		super(id);
	}
	...
	public void initializeAttributes() {
		...
		addManyToOneRelationship(getColumnOwnerGroup(), "Owner group", Group.class);
		...
		addManyToManyRelationShip(com.idega.core.component.data.ICObjectInstance.class, "IC_OBJ_INST_INFO_FOLDER");
	}
