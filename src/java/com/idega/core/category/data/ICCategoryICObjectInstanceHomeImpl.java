...
public int getOrderNumber(com.idega.core.category.data.Category p0,com.idega.core.component.data.ICObjectInstance p1)throws javax.ejb.FinderException{
...
public java.util.List getListOfCategoryForObjectInstance(com.idega.core.component.data.ICObjectInstance p0)throws javax.ejb.FinderException{
	com.idega.data.IDOEntity entity = this.idoCheckOutPooledEntity();
