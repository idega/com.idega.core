...
public class CategoryFinder {
	...
	public List listOfCategories(String type) {
		try {
			return EntityFinder.findAllByColumn(
				com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class),
				com.idega.core.category.data.ICCategoryBMPBean.getColumnType(),
				type);
		}
	...
	public List listOfValidCategories() {
		try {
			return EntityFinder.findAllByColumn(
				com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class),
				com.idega.core.category.data.ICCategoryBMPBean.getColumnValid(),
				"Y");
		}
		catch (SQLException ex) {
			return null;
	...
	public int getObjectInstanceCategoryId(ICObjectInstance eObjectInstance) {
		try {
			List L =
				EntityFinder.findRelated(
					eObjectInstance,
					(IDOLegacyEntity) com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class));
			if (L != null) {
	...
	public int[] getObjectInstanceCategoryIds(int ICObjectInstanceId) {
		...
		ICCategory cat = (ICCategory) com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class);
		ICObjectInstance obj =
		...
		try {
			...
			List L =
				EntityFinder.getInstance().findRelated(
					obj,
					(ICCategory) com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class));
			return L;
		}
		catch (Exception ex) {
			return null;
	...
	private String getRelatedEntitySQL(String tablename, int iObjectInstanceId) {
		...
		sql.append(" = ").append(iObjectInstanceId);
		String idname =
			((ICCategory) com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class)).getIDColumnName();
	...
	private String getRelatedEntitySql(
		...
		CategoryEntity catEntity =
			(CategoryEntity) com.idega.data.CategoryEntityBMPBean.getStaticInstance(CategoryEntityClass);
		ICObjectInstance instanceEntity =
			(ICObjectInstance) com.idega.core.component.data.ICObjectInstanceBMPBean.getStaticInstance(ICObjectInstance.class);
		ICCategory icCat = ((ICCategory) com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class));
		String middletable = EntityControl.getManyToManyRelationShipTableName(ICCategory.class, ICObjectInstance.class);
		StringBuffer sql = new StringBuffer("select ");
		...
		sql.append(" = ").append(catEntity.getEntityName()).append(".").append(
			com.idega.data.CategoryEntityBMPBean.getColumnCategoryId());
	...
	public Collection getCategories(int[] ids, String type) {
		...
		ICCategory cat = (ICCategory) com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class);
		sql.append(com.idega.core.category.data.ICCategoryBMPBean.getEntityTableName());
		sql.append(" where ").append(com.idega.core.category.data.ICCategoryBMPBean.getColumnType()).append(" = ").append(type);
	...
	public Map getMapOfCategoriesById(int instanceId) {
		return EntityFinder.getInstance().getMapOfEntity(
			...
			com.idega.core.category.data.ICCategoryBMPBean.getStaticInstance(ICCategory.class).getIDColumnName());
	}
