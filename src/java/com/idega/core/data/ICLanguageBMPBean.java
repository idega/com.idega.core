...
public class ICLanguageBMPBean extends com.idega.data.GenericEntity implements com.idega.core.data.ICLanguage {
  ...
  public void insertStartData()throws Exception{
    ...
    for (int i = 0; i < JavaLocales.length; i++) {
      lang = ((com.idega.core.data.ICLanguageHome)com.idega.data.IDOLookup.getHomeLegacy(ICLanguage.class)).createLegacy();
