...
public class GenericGroupBMPBean extends com.idega.data.GenericEntity implements com.idega.core.data.GenericGroup {
	...
	public void setExtraInfo(String extraInfo){
        ...
        public static void addUser(int groupId, User user)throws SQLException{
          ...
          ((com.idega.core.data.GenericGroupHome)com.idega.data.IDOLookup.getHomeLegacy(GenericGroup.class)).findByPrimaryKeyLegacy(groupId).addGroup(user.getGroupID());
        ...
        public static List getAllGroups(String[] groupTypes, boolean returnSepcifiedGroupTypes) throws SQLException {
          ...
          if (groupTypes != null && groupTypes.length > 0){
            ...
            return EntityFinder.findAll(gr,"select * from "+gr.getEntityName()+" where "+com.idega.core.data.GenericGroupBMPBean.getGroupTypeColumnName()+((returnSepcifiedGroupTypes)?" in (":" not in (")+typeList+") order by "+com.idega.core.data.GenericGroupBMPBean.getNameColumnName());

          }

          return EntityFinder.findAllOrdered(com.idega.core.data.GenericGroupBMPBean.getStaticInstance(),com.idega.core.data.GenericGroupBMPBean.getNameColumnName());
