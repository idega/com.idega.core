...
public class ICProtocolBMPBean extends com.idega.core.data.GenericTypeBMPBean implements com.idega.core.data.ICProtocol {
  ...
  public void insertStartData() {
    try {
      ICProtocol icp = ((com.idega.core.data.ICProtocolHome)com.idega.data.IDOLookup.getHomeLegacy(ICProtocol.class)).createLegacy();
      icp.setName(_PROTOCOL_HTTP);
      icp.setDescription("Hypertext Transfer Protocol");
      icp.insert();

      icp = ((com.idega.core.data.ICProtocolHome)com.idega.data.IDOLookup.getHomeLegacy(ICProtocol.class)).createLegacy();
