...
public class AddressTypeBMPBean extends com.idega.core.data.GenericTypeBMPBean implements com.idega.core.data.AddressType {
  ...
  public final static String ADDRESS_2 = "ic_user_address_2";
	...
	public String getEntityName(){
        ...
        public void insertStartData()throws Exception{
          ...
          at = ((com.idega.core.data.AddressTypeHome)com.idega.data.IDOLookup.getHomeLegacy(AddressType.class)).createLegacy();
