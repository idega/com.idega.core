/*
 * $Id: ICApplicationBMPBean.java,v 1.1 2006/06/15 17:53:23 tryggvil Exp $ Created on
 ...
 */
public class ICApplicationBMPBean extends GenericEntity {

	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 601035836606742324L;
	public static final String TABLE_NAME = "IC_APPLICATION";
	public static final String COLUMNNAME_NAME = "APPLICATION_NAME";
	public static final String COLUMNNAME_CREATEDATE = "CREATION_DATE";

	/**
	 * 
	 */
	public ICApplicationBMPBean() {
		super();
	...
	public void initializeAttributes() {
		...
		addUniqueIDColumn();
		addAttribute(COLUMNNAME_CREATEDATE, "Application Creation date", Timestamp.class);
		/*
