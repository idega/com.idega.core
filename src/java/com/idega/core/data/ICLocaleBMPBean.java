...
public class ICLocaleBMPBean extends com.idega.data.GenericEntity implements com.idega.core.data.ICLocale {
  ...
  public void insertStartData() throws Exception{
    ...
    for (int i = 0; i < JavaLocales.length; i++) {
      il = ((com.idega.core.data.ICLocaleHome)com.idega.data.IDOLookup.getHomeLegacy(ICLocale.class)).createLegacy();
