...
public class ICObjectBMPBean extends com.idega.data.GenericEntity implements com.idega.core.data.ICObject {
	...
	public void initializeAttributes(){
        ...
        public static List getAvailableComponentTypes(){
          ...
          if(componentList==null){
            ...
            componentList.add(com.idega.core.data.ICObjectBMPBean.COMPONENT_TYPE_ELEMENT);

            componentList.add(com.idega.core.data.ICObjectBMPBean.COMPONENT_TYPE_BLOCK);

            componentList.add(com.idega.core.data.ICObjectBMPBean.COMPONENT_TYPE_APPLICATION);
