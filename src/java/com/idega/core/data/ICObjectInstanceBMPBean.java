...
public class ICObjectInstanceBMPBean extends com.idega.data.GenericEntity implements com.idega.core.data.ICObjectInstance {
  ...
  public ICObjectInstanceBMPBean(int id)throws SQLException{
    super(id);
  }
