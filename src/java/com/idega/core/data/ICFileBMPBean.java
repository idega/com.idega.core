...
// and here are the delete functions
  ...
  public boolean isLeaf(){
    if(com.idega.core.data.ICMimeTypeBMPBean.IC_MIME_TYPE_FOLDER.equalsIgnoreCase(this.getMimeType())){
      return false;
    }
    return true;
  }
  ...
  public void unDelete(boolean setICRootAsParent) throws SQLException {
    ...
    try{
      ...
      if( setICRootAsParent ){
        ...
        ICFile parent = (ICFile) cm.getCachedEntity(com.idega.core.data.ICFileBMPBean.IC_ROOT_FOLDER_CACHE_KEY);
