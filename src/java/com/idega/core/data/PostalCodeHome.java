...
public interface PostalCodeHome extends com.idega.data.IDOHome
{
 ...
 public java.util.Collection findAllByCountryIdOrderedByPostalCode(int p0)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
