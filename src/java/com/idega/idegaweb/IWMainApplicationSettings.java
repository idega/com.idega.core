 ...
 * on an application-wide basis. This class is responsible for reading the
 * properties set in idegaweb.pxml and also holds some default values that don't
 * have to be explicitly set in the idegaweb.pxml properties file.
 * </p>
...
public class IWMainApplicationSettings implements MutableClass {
	...
	private static final int MAX_KEY_LENGTH = ApplicationBinding.MAX_KEY_LENGTH;
	...
	@Autowired
	private ApplicationBindingDAO applicationBindingDAO;
...
>>>>>>> e985a190b3270919ad15d235fc793501e7d9a683
	...
	/**
	 * @return The character encoding string for example UTF-16 or the default
	 *         ISO-8859-1
	 */
	public String getCharacterEncoding() {
		...
		if (DEFAULT_CHARACTER_ENCODING == null) {
			...
			if (DEFAULT_CHARACTER_ENCODING == null) {
				// if still there is no character encoding from the jvm, set it as
				// unicode:
