...
public class SystemProperties extends Block {
	...
	private Form getPropertyForm() {
		Form form = new Form();
		form.add(new HiddenInput(this.PARAMETER_ACTION, String.valueOf(ACTION_SAVE)));
		if (this.systemProperty != null) {
		...
		if (this._property != null && this.action != ACTION_DELETE) {
	...
	private Form getPropertiesForm() {
		Form form = new Form();
		form.add(new HiddenInput(this.PARAMETER_ACTION, String.valueOf(ACTION_DELETE)));
		if (this.systemProperty != null) {
			form.add(new HiddenInput(this.SYSTEM_PROPERTY, this.systemProperty));
		}
	...
	private DropdownMenu getPropertyTypeMenu() {
		...
		menu.addMenuElement(TYPE_PROPERTY, this._iwrb.getLocalizedString("type_property", "Property"));
		menu.addMenuElement(TYPE_MAP, this._iwrb.getLocalizedString("type_map", "Category"));
		return menu;
	}
