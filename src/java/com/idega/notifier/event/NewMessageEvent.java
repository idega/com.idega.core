/**
 * @(#)NewMessageEvent.java    1.0.0 2:00:29 PM
 *
 ...
 */
package com.idega.notifier.event;
...
public class NewMessageEvent extends ApplicationEvent {
	...
	private Collection<User> receivers = null;
	
	public NewMessageEvent(String message, User sender, 
