...
/**
 * Class to override the standard iterator for the method getFacetsAndChildren()
 * in UIComponent
 * 
 ...
 */
class FacetsAndChildrenIterator implements Iterator {
	...
	FacetsAndChildrenIterator(Map facetMap, List childrenList) {
		this._facetsIterator = facetMap != null ? facetMap.values().iterator()
				: null;
		this._childrenIterator = childrenList != null ? childrenList.iterator()
				: null;
	}
	...
	public boolean hasNext() {
		...
		facetsHasNext = (this._facetsIterator != null && this._facetsIterator
				.hasNext());
		childrenHasNext = (this._childrenIterator != null && this._childrenIterator
				.hasNext());
