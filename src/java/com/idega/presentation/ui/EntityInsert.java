...
public EntityInsert(IDOLegacyEntity entity){
...
public EntityInsert(IDOLegacyEntity entity,String redirectURLAfterInsert){
...
public String getField(IDOLegacyEntity entity,int fieldNumber){
...
protected void setHorizontalInsertableList(IDOLegacyEntity entity){
...
private int getNumberOfFields(IDOLegacyEntity entity){
...
public String[] getVisibleColumnNames(IDOLegacyEntity entity){
...
public IDOLegacyEntity getInsertedObject(IWContext iwc){

	IDOLegacyEntity returnObject = (IDOLegacyEntity)iwc.getSessionAttribute(sessionStorageParameterName);
