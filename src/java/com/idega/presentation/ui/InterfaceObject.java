...
public class InterfaceObject extends PresentationObject {
	...
	public String getActionString(IWContext iwc) throws IOException {
		...
		if (getLanguage().equals("HTML")) {
			if (getOnFocus() != null)				//{ActionString = ActionString + " ONFOCUS=\""+getOnFocus()+"\" ";}
				{
				ActionString.append(" ONFOCUS=\"");
				ActionString.append(getOnFocus());
				ActionString.append("\" ");
			}
			if (getOnBlur() != null)				//{ActionString = ActionString + " ONBLUR=\""+getOnBlur()+"\" ";}
				{
				ActionString.append(" ONBLUR=\"");
				ActionString.append(getOnBlur());
				ActionString.append("\" ");
			}
			if (getOnSelect() != null)				//{ActionString = ActionString + " ONSELECT=\""+getOnSelect()+"\" ";}
				{
				ActionString.append(" ONSELECT=\"");
				ActionString.append(getOnSelect());
				ActionString.append("\" ");
			}
			if (getOnChange() != null)				//{ActionString = ActionString + " ONCHANGE=\""+getOnChange()+"\" ";}
				{
				ActionString.append(" ONCHANGE=\"");
				ActionString.append(getOnChange());
				ActionString.append("\" ");
			}
			if (getOnClick() != null)				//{ActionString = ActionString + " ONCLICK=\""+getOnClick()+"\" ";}
				{
