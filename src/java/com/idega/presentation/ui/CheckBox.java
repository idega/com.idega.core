...
public class CheckBox extends GenericInput {
	...
	/**
	 * Constructs a new <code>CheckBox</code> with name set as "untitled" and
	...
	/**
	 * Constructs a new <code>CheckBox</code> with the given name and value as
	 * "unspecified".
	 */
	...
	public void main(IWContext iwc) {
		if (isEnclosedByForm()) {
			if (this._mustBeChecked) {
				...
				this.setOnSubmitFunction("isChecked", buffer.toString(),
						this._errorMessage);
			}
	...
	public void setToEnableWhenChecked(InterfaceObject object) {
		...
		setOnAction(ACTION_ON_CLICK, "enableWhenChecked(this, findObj('"
				+ object.getName() + "'))");
	}

	public void setToDisableWhenUnchecked(InterfaceObject object) {
		this._disableWhenUnchecked = true;
		setOnAction(ACTION_ON_CLICK, "disableWhenUnchecked(this, findObj('"
				+ object.getName() + "'))");
	}

	public void setToDisableWhenChecked(InterfaceObject object) {
		this._disableWhenChecked = true;
		setOnAction(ACTION_ON_CLICK, "disableWhenChecked(this, findObj('"
				+ object.getName() + "'))");
	}

	public void setToEnableWhenUnchecked(InterfaceObject object) {
		this._enableWhenUnchecked = true;
		setOnAction(ACTION_ON_CLICK, "enableWhenUnchecked(this, findObj('"
				+ object.getName() + "'))");
	}

	public void setToCheckWhenCheckedAndUncheckWhenUnchecked(
	...
	public void setToCheckWhenCheckedAndUncheckWhenUnchecked(String objectName) {
		...
		setOnAction(ACTION_ON_CLICK, "toggleOnChange(this, findObj('"
				+ objectName + "'))");
	}
	...
	public void printWML(IWContext main) {
		print("<option value=\"" + getValueAsString() + "\">" + getContent()
				+ "</option>");
	}
}