 ...
 * @author idega 2000 - idega team - <a href="mailto:gummi@idega.is">Gu�mundur �. S�mundsson</a>
...
public class MenuBar extends InterfaceObject {
  ...
  public MenuBar() {
    ...
    this.ScriptObject = new Script("javascript");
    ...
    this.scriptCodeInit = null;

    this.varString = null;

    this.addFunction = new String[50];
  ...
  private void set_initString(){
        ...
        this.initString += "var isMinNS4=(navigator.appName.indexOf(\"Netscape\")>=0&&parseFloat(navigator.appVersion)>=4)?1:0;\r";

        this.initString += "var isMinIE4=(document.all)?1:0;var isMinIE5=(isMinIE4&&navigator.appVersion.indexOf(\"5.\")>=0)?1:0;\r";
  ...
  private void set_functionString(){
	...
	this.functionString = "\r";

	this.functionString += "function hideLayer(layer) {\r";

	this.functionString += "\r";

	this.functionString += "if(isMinNS4)layer.visibility=\"hide\";\r";

	this.functionString += "if(isMinIE4)layer.style.visibility=\"hidden\";\r";
	...
	this.functionString += "function showLayer(layer) {\r";

	this.functionString += "\r";

	this.functionString += "if(isMinNS4)layer.visibility=\"show\";\r";

	this.functionString += "if(isMinIE4)layer.style.visibility=\"visible\";\r";
  ...
  public void set_navBarReloadonresize(){
      ...
      this.functionString += "window.onresize=navBarReload;\r\r";
  ...
  private void set_initFunction(){
	...
	this.initFunction_begin = "\r";

	this.initFunction_begin += "var fullWidth;\r";

	this.initFunction_begin += "\r";

	this.initFunction_begin += "function init() {\r";

	this.initFunction_begin += "\r";

	this.initFunction_begin += "  // Get width of window, need to account for scrollbar width in Netscape.\r";

	this.initFunction_begin += "\r";

	this.initFunction_begin += "  fullWidth = getWindowWidth()\r";

	this.initFunction_begin += "    - (isMinNS4 && getWindowHeight() < getPageHeight() ? 16 : 0);\r";

	this.initFunction_begin += "\r";

	this.initFunction_begin += "  NavBar1.create();\r";



        this.initFunction_var = "\r";

	this.initFunction_var += "  NavBar1.moveTo("+this.x_pos+", "+this.y_pos+");\r";

	this.initFunction_var += "  NavBar1.setzIndex(2);\r";



        this.initFunction_end = "}\r";
  ...
  private String get_scriptString(){
    ...
    this.scriptString += "\r" + this.scriptCodeInit + "\r" + this.NavBarSettings + "\r" + this.scriptCode + "\r" + addFunctions() + "\r";
  ...
  private String get_initFunction(){
    ...
    return  this.initFunction_begin + this.initFunction_var + this.initFunction_end;
  ...
  public void addItem(String MenuName, String ItemName, String url){
    ...
    this.scriptCode += MenuName + ".addItem(new NavBarMenuItem( \"" + ItemName + "\" , \"" + url + "\" ));\r" ;
  ...
  public void addItem(String MenuName, String ItemName){
    ...
    this.scriptCode += MenuName + ".addItem(new NavBarMenuItem( \"" + ItemName + "\" ));\r" ;
  ...
  public void addMenu(String MenuName, int hdrWidth, int menuWidth){
    ...
    if (this.scriptCodeInit == null || this.varString == null){
    ...
    this.varString += "var " + MenuName + ";\r";



    this.scriptCodeInit +=  MenuName + " = new NavBarMenu("+hdrWidth+","+menuWidth+");\r";



    this.addFunction[this.counter++] = "NavBar1.addMenu(" + MenuName + ");\r";
  ...
  private String addFunctions(){
    ...
    if (this.addFunction!= null){
      ...
      while (this.addFunction[i] != null){

        temp += this.addFunction[i] + "\r";
  ...
  private void addNavBar(){
    ...
    this.varString = "var NavBar1;\r";

    this.scriptCodeInit = "NavBar1 = new NavBar(getWindowWidth());\r";
  ...
  private void addNavBar(int width){
    ...
    this.scriptCodeInit = "NavBar1 = new NavBar("+width+");\r";
  ...
  private void setNavBarSettings(){
    ...
    this.NavBarSettings = "\r";

    this.NavBarSettings += this.NavBar_setSizes;

    this.NavBarSettings += this.NavBar_setColors;

    this.NavBarSettings += this.NavBar_setFonts;
  ...
  private void addDefaultNavBarSettings(){
    ...
    if (this.NavBar_setSizes == null) {
		this.NavBar_setSizes = "NavBar1.setSizes(1, 1, 0);\r";
	}



    if (this.NavBar_setColors == null) {
		this.NavBar_setColors = "NavBar1.setColors(\"#444444\",  \"#FFFFFF\", \"#BDBDBD\", \"#444444\", \"#F2BC00\",  \"#444444\", \"#BDBDBD\", \"#F2BC00\", \"#444444\");\r";
	}



    if ( this.NavBar_setFonts == null) {
		this.NavBar_setFonts =  "NavBar1.setFonts(\"Arial, Helvetica, sans-serif\", \"normal\", \"normal\", \"8pt\",\"Arial, Helvetica, sans-serif\", \"normal\", \"normal\", \"8pt\");\r";
	}
  ...
  public void setSizes(int border, int padding, int separator){
    ...
    this.NavBar_setSizes = "NavBar1.setSizes("+border+", "+padding+", "+separator+");\r";
  ...
  public void setColors( String bdColor, String hdrFgColor,String hdrBgColor, String hdrHiFgColor, String hdrHiBgColor, String itmFgColor, String itmBgColor, String itmHiFgColor, String itmHiBgColor ){
    ...
    this.NavBar_setColors = "NavBar1.setColors(\"" + bdColor + "\",\"" + hdrFgColor + "\",\"" + hdrBgColor + "\",\"" + hdrHiFgColor + "\",\"" + hdrHiBgColor + "\",\"" + itmFgColor + "\",\"" + itmBgColor + "\",\"" + itmHiFgColor + "\",\"" + itmHiBgColor + "\");\r";
  ...
  public void setFonts( String hdrFamily1, String hdrFamily2, String hdrFamily3, String hdrStyle, String hdrWeight, int hdrSize, String itmFamily1, String itmFamily2, String itmFamily3, String itmStyle, String itmWeight, int itmSize){
    ...
    this.NavBar_setFonts = "NavBar1.setFonts(\"" + hdrFamily1 + "," +hdrFamily2+ "," +hdrFamily3+ "\",\"" +hdrStyle+ "\",\"" +hdrWeight+ "\",\"" +hdrSize+ "pt\",\"" +itmFamily1+ "," +itmFamily2+ "," +itmFamily3+ "\",\"" +itmStyle+ "\",\"" +itmWeight+ "\",\"" +itmSize+ "pt\");\r";;
  ...
  private void setScriptSource(String Source){
    ...
    this.ScriptObject.removeFunction("menu");

    this.ScriptObject.addFunction("menu",Source);
