...
/**
 * @todo Kalla � TabPagePresentation hlut fr� ui-inu og setja vi�eigani s��u �
 *       hann.
 * 
 * @todo Selecta vi�eigandi hlut og l�ta TabPresentatnion vita. Nota alltaf
 * sama TabPresentation hlutinn en kalla � fireStateChange() falli�.
 * adda � Tabpresentationhlutinn um lei� og hlut er adda� � TabbedPane. Veldur
 * vandr��um ef a� skipta � um UI �v� �� �arf a� adda �llu � TabPresentation aftur.
 * 
 * @todo stroka �t setBorder � Table
 */