...
public class IWApplication extends FrameSet{
  ...
  public static List getApplictionICObjects(){
    ...
    try{
      ...
      return EntityFinder.findAllByColumn(com.idega.data.GenericEntity.getStaticInstance(ICObject.class),com.idega.core.data.ICObjectBMPBean.getObjectTypeColumnName(),com.idega.core.data.ICObjectBMPBean.COMPONENT_TYPE_APPLICATION);
