...
public class IWSessionsDaemon implements IWBundleStartable, ActionListener {
	...
	private static final String IW_SESSIONS_DAEMON = "IW_SESSIONS_DAEMON";
	...
	public void actionPerformed(ActionEvent event) {
		try {	
			if (event.getActionCommand().equalsIgnoreCase(IW_SESSIONS_DAEMON)) {
				LOGGER.info("Removed useless sessions: " + getSessionsManager().removeUselessSessions());
			}
		} catch(Exception e) {
