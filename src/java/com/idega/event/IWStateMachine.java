...
public interface IWStateMachine extends com.idega.business.IBOSession
{
 ...
 public java.util.Collection getAllControllers() throws java.rmi.RemoteException;
 public java.util.Collection getAllChangeListeners() throws java.rmi.RemoteException;
}
